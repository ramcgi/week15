...
function App() {
  /* -- YOUR CODE/CRUD OPERATIONS HERE --*/
    ...
    const Mock_API_URL = "https://64f233e20e1e60602d24e38b.mockapi.io/week12lab"
    ...
    function postNewUser(e){
      ...
      let data = {
        ...
        researchAssignment: newUserJobTitle,
     ...
     function updateUser(e,userObject){
      ...
      let updatedUserObject= {
        ...
        researchAssignment:updatedJobTitle,

        id:updatedCompanyName,
      }

      fetch(`${MOCK_API_URL}/${id}, {userObject.id}`,{
        method: 'PUT',
  ...
  return (
    <div className="App">
      ...
      <label>ResearchAssignment</label>
      ...
      {users.map((user,index) => (
        <div className="UserContainer" key = {index}>
          <div>
            fullName: {week12lab.fullName} <br></br>
            researchAssignment: {week12lab.researchAssignment}<br></br>
            id: {week12lab.id}<br></br>
           <button onClick ={()=>deleteUser(week12lab.id)}> Delete</button>
          </div>
          <form>
            ...
            <h3></h3>
            <label>Update ResearchAssignment</label>
            <input input onChange={(e) => setUpdatedJobTitle(e.target.value)}></input><br></br>


            <h3></h3>
            <label>Update id</label>
            <input input onChange={(e) => setUpdatedCompanyName(e.target.value)}></input><br></br>
